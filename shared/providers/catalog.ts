...
export const providerCatalog = [
  {
    id: 'openai',
    name: 'OpenAI',
    description: '官方 Responses API，亦可显式选择 Chat Completions。',
    icon: 'openai.svg',
  ...
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
    description: '官方 OpenAI-compatible API，支持独立思考开关。',
  ...
  },
  {
    id: 'gemini',
    name: 'Google Gemini',
    description: 'Google Generative Language 原生 API。',
    icon: 'gemini-color.svg',
    defaultBaseUrl: 'https://generativelanguage.googleapis.com/v1beta',
    defaultProtocol: 'gemini-generative-language',
    protocols: ['gemini-generative-language'],
    modelDiscovery: true,
  },
  {
    id: 'bailian',
  ...
  },
  {
    id: 'moonshot',
    name: 'Moonshot',
    description: 'Moonshot AI OpenAI 兼容端点。',
    icon: 'moonshot.svg',
  ...
  },
  {
    id: 'zhipu',
    name: '智谱 AI',
    description: 'BigModel OpenAI 兼容端点。',
  ...
  },
  {
    id: 'siliconflow',
    name: '硅基流动',
    description: 'SiliconCloud OpenAI 兼容端点。',
  ...
  },
  {
    id: 'custom',
    name: '自定义网关',
    description: '为 sub2api 或其他网关指定其真实对外协议。',
    icon: 'gateway.svg',
