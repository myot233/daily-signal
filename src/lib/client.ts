...
import type { AppState, DigestGenerationEvent, DigestInput } from '../../shared/types';
...
export const rpc: ContractRouterClient<typeof contract> = createORPCClient(
  new RPCLink({
...
export function errorMessage(error: unknown) {
  ...
  if (error instanceof Error && !(error instanceof ORPCError) && !(error instanceof TypeError))
