...
export const ReadyToGenerate: Story = {
  play: async ({ canvasElement, userEvent }) => {
    ...
    await expect(canvas.getByRole('heading', { level: 1, name: '把今天的文章，变成可追溯的洞见。' })).toBeVisible()
...
export const Generating: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByRole('button', { name: '正在提取资料批次 2/3' })).toHaveAttribute('aria-expanded', 'true')
  },
}
