...
const meta = {
  ...
  render: () => (
    <Dialog>
      <DialogTrigger asChild><Button>删除订阅源</Button></DialogTrigger>
      <DialogContent>
        <DialogHeader>
        ...
        <DialogFooter>
          <DialogClose asChild><Button variant="outline">保留订阅</Button></DialogClose>
...
export const Open: Story = {
  play: async ({ canvasElement, userEvent }) => {
    ...
    await waitFor(() => expect(within(canvasElement.ownerDocument.body).getByRole('dialog')).toBeVisible());
  },
};
